...
public final class Logger
{
            ...
            try
            {
                ...
                String str =
                    new StringBuilder().append("[")
                        ...
                        .append(getNul(String.valueOf(Thread.currentThread().getId()), 4))
                        .append("]")
                        .append("--")
                        .append("--<")
                        .append(className)
                        .append(getNul(className, 70))
                        .append(">:")
                        .append(logMsg)
                        .append("\n")
                        .toString();
    ...
    {
        String fileLocStr =
            getProperty("LOG_FILE_LOCATION", Environment.getExternalStorageDirectory().getAbsolutePath() + "/").trim();
